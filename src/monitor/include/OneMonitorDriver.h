...
private:
     ...
     */
    static void _host_list(std::unique_ptr<message_t> msg);

    /**
     *  Update information from a host
     */
    static void _update_host(std::unique_ptr<message_t> msg);

    /**
     *  Remove host from the pool
     */
    static void _del_host(std::unique_ptr<message_t> msg);
     ...
     */
    static void _stop_monitor(std::unique_ptr<message_t> msg);

    /**
     *  Raft status changed
     */
    static void _raft_status(std::unique_ptr<message_t> msg);
